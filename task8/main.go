...
// Решение
/*
Сначала мы получаем с стандартного ввода число.
Затем переводим его в строку представляющую значение числа в двоичной системе (0, 1)
Затем сообщаем количество битов.
Затем принимаем значение - кокой бит будем менять
И значение на что поменять 0 или 1.
Затем воссоздаем новую строку битов и заменяем по индексу нужный нам бит
Затем используя функцию BinaryStringToInt получаем новую строку битов
и переводим ее в число в 10-чной системе. И выводим это число.
*/
