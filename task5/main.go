...
/* Решение
   1) Мы принимаем int N и задаем продолжительность в секундах N * time.Second
   2) Затем запускаем две горутины, 1я отправляет значения в бесконечном цикле в канал inOutCh
